...
# Genelleştirmek istersek;
# Kullanıcıların %60'ı seçilen kişiyle aynı filmi izlesin diye bir kural koyduğumuzu varsayalım.
...
user_based_recommender(random_user, user_movie_df, cor_th=0.70)
