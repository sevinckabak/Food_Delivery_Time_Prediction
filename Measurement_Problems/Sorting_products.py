...
df = pd.read_csv(r"/Measurement_Problems\datasets\product_sorting.csv")
print(df.shape)

df.head()
# comment_count: yorumlu ya da yorumsuz tüm değerlendirmeler.
...
# Puan dağılımları üzerinden olasılıklı ortalama hesaplar.
# Sadece rate'e göre sıralama yapar.
...
df = pd.read_csv(r"Python/Measurement_Problems/datasets/movies_metadata.csv",
...
df = pd.read_csv(r"Python/Measurement_Problems/datasets/imdb_ratings.csv")
df = df.iloc[0:, 1:]
