...
# Ortileri seviyede bir py dosyasında sadece fonksiyonlar (pipeline) olur.
...
# Ensemble Learning; RF'de birden fazla ağavın bir araya gelerek bir tahmin yürütmesinde gündeme gelmiştir.
# Örn; knn gel bakalım, rf gel bakalım, lightgbm gel bakalım hep birlikte tahmin edeceğiz.
...
# votingin regresyon versiyonu da var.
# Soft vote; sınıf gerçekleşme olasılıkları üzerinden oylama yapar.
# hard vote; iki model 1 diğeri 0 dediyse tahmini 1 yapar. en fazla oyu alan sınıfı getirir.
# bana kullanacağın modelleri söyle
# topluluğun gücü
...
# model gitmesin istiyorsak modeli kaydediyoruz.
